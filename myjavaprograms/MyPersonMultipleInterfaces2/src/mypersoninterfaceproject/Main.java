...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        AnotherInterface anotherinterfaceexample1 = person1;
        ...
        // Display first name's length
        System.out.println("person1.computeFirstNameLength() = " + person1.computeFirstNameLength(person1.firstName)) ; 
