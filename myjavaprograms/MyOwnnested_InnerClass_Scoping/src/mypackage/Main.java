...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Access data from outer class = " + oc.data); // 7
        System.out.println("Access data2 from inner class = " + ic.data2);  // 10 
        System.out.println("Access data3 from innerinner class = " + iic.data3); // 15 

        // Invoke a method from an inner class
        ic.method();
        
        // Invoke a method from the "inner inner" class
        iic.method2();
