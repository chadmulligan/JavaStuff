...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        PersonAnother3 person3 = new PersonAnother3(100000, 25000, "chad", "mulligan"); 
        PersonInterface3 personInterface3 = person3 ; 
        System.out.println("person3.toChangeNameToUpperCase() = " + personInterface3.toChangeNameToUpperCase());
        boolean b2 = (person3 == personInterface3); 
        System.out.println("person3 == personInterface3 ? " +b2) ;
